...
use WCS\FlyAroundBundle\Entity\PlaneModel;
...
class PlaneModelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $planeModels = $em->getRepository('WCSFlyAroundBundle:PlaneModel')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('WCS\FlyAroundBundle\Form\PlaneModelType', $planeModel);
    ...
    {
        $deleteForm = $this->createDeleteForm($planeModel);
        $editForm = $this->createForm('WCS\FlyAroundBundle\Form\PlaneModelType', $planeModel);
