...
use WCS\FlyAroundBundle\Entity\Flight;
...
class FlightController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $flights = $em->getRepository('WCSFlyAroundBundle:Flight')->findAll();
    ...
    {
        $flight = new Flight();
        $form = $this->createForm('WCS\FlyAroundBundle\Form\FlightType', $flight);
    ...
    {
        $deleteForm = $this->createDeleteForm($flight);
        $editForm = $this->createForm('WCS\FlyAroundBundle\Form\FlightType', $flight);
